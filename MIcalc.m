...
hold off
grid on
saveas(gcf,'mutual_information.pdf')
saveas(gcf,'mutual_information.fig')
xlabel('Global coupling strength \epsilon');
...
hold off
grid on
saveas(gcf,'f2_mutual_information.pdf')
saveas(gcf,'f2_mutual_information.fig')
%%
...
% Add utilities to the path
    ...
    calc = javaObject('infodynamics.measures.discrete.MutualInformationCalculatorDiscrete', 101,101, 0);
